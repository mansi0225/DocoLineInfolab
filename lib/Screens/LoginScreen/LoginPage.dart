...
import 'package:newdocolineproject/Screens/SignUpScreen/SignUpPage.dart';
import 'package:newdocolineproject/Screens/UserHomePage/HomePage.dart';
...
import 'LoginModel/LoginApi.dart';
...
class _LoginPageState extends State<LoginPage> {
  ...
  login(String Email, Password) async {
    ...
    var response = await http.post( Uri.parse("https://docoappo27.000webhostapp.com/user/ulogin.php"), body: data);
    ...
    if(response.statusCode == 200) {
      if (!loginApi.error) {
        ...
        sharedPreferences.setString("uid",loginApi.user.uid);
        sharedPreferences.setString("uname",loginApi.user.uname);
        sharedPreferences.setString("uemail",loginApi.user.uemail);
        sharedPreferences.setString("role","2");
        ...
        child: Column(
            children: <Widget>[
              Container(
                width: 120,
                height: 120,
                child: new Image.asset('assets/images/healthcare.png'),
              ),
              SizedBox(height: 20,),
              Container(
    ...
    return Container(
      ...
      child: Column(
        children: <Widget>[
          ...
          InkWell(
            onTap: (){
              Navigator.of(context).push(MaterialPageRoute(builder: (context) => UserOtp(),));
            },
            child: Text(
              ' Forget Password',
              style: TextStyle(
