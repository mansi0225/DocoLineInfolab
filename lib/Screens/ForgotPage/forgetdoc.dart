...
class DocOtp extends StatefulWidget {
  const DocOtp({Key? key}) : super(key: key);

  @override
  State<DocOtp> createState() => _DocOtpState();
}

class _DocOtpState extends State<DocOtp> {
                          ...
                          MaterialButton(
                            ...
                            onPressed: () async {
                              if (await myauth.verifyOTP(otp: otp.text) == true) {
                                ...
                                Navigator.pushReplacement(context, MaterialPageRoute(builder:(context) => ResetNewDoc(),));
                              } else {
                                Fluttertoast.showToast(
                                    msg: "Invalid OTP",
                                    toastLength: Toast.LENGTH_LONG,
