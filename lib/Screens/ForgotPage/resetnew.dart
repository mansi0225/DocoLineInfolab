...
class ResetNew extends StatefulWidget {
  @override
  _ResetNewState createState() => _ResetNewState();
}

class _ResetNewState extends State<ResetNew> {
  ...
  Reset1(String name,email) async {
    ...
    var response = await http.post(Uri.parse("https://docoappo27.000webhostapp.com/forget%20password/userforgetpass.php"), body: data);
    ...
    if(response.statusCode == 200) {
      if (!commonClass.error) {
        ...
        print(data1["user"]["upass"].toString());

        var pass11=data1["user"]["upass"].toString();
          setState(() {
...
//              ),
  ...
  void _submit() {
    ...
    if (form!.validate()) {
      ...
      Reset1(nameController.text, emailController.text);
    }
  }
